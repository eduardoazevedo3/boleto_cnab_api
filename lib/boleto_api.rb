...
module BoletoApi
  ...
  class Server < Grape::API
    ...
    resource :boleto do
      ...
      # boleto fields are listed here: https://github.com/kivanio/brcobranca/blob/master/lib/brcobranca/boleto/base.rb
      # BOLEPIX: Add "emv" field to the data JSON to include PIX QR Code payment option
      params do
        requires :bank, type: String, desc: 'Bank'
      ...
      # boleto fields are listed here: https://github.com/kivanio/brcobranca/blob/master/lib/brcobranca/boleto/base.rb
      # BOLEPIX: Add "emv" field to each boleto in the JSON array to include PIX QR Code payment option
      params do
